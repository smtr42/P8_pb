...
class ProductModeltest(TestCase):
    @classmethod
    def setUpTestData(cls):
        Product.objects.create(barcode="1125896345237", product_name="Salade sans sauce", nutriscore="A", url="http://openfoodfact.fr/salade", image_url="http://openfoodfact.fr/img_salade", image_nut_url="http:/openfoodfact.fr/img_nut_url")
